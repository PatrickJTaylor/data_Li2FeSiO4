...
The geometry of Li<sub>2</sub>FeSiO<sub>4</sub> required to plot figure 1, as well as the `xsf` files necessary to plot the Wannier isosurfaces of Figure 4 can all be found in [extracted_data/sequential_delithiation/](https://github.com/PatrickJTaylor/data_Li2FeSiO4/tree/main/extracted_data/sequential_delithiation).
